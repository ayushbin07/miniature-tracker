...
-- CreateEnum
CREATE TYPE "AvatarType" AS ENUM ('GENERATED', 'CUSTOM');

-- AlterTable
ALTER TABLE "Habit" ADD COLUMN     "categoryId" TEXT;

-- AlterTable
ALTER TABLE "User" ADD COLUMN     "avatarSeed" TEXT NOT NULL,
ADD COLUMN     "avatarType" "AvatarType" NOT NULL DEFAULT 'GENERATED',
